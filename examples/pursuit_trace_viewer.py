...
def _rollout_config_from_draft(draft: Mapping[str, object]) -> PursuitRolloutConfig:
...
def _default_draft_config() -> dict[str, object]:
    return {
        "seed": 7,
        "grid_size": [9, 9],
        "num_evaders": 2,
...
def _active_config_from_trace(trace: Any) -> dict[str, object]:
    metadata = trace_metadata(trace)
    return {
        "source": "loaded_trace",
